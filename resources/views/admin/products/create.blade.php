...
<form  action="@if(isset($product)) {{route('admin.product.update', $product)}} @else {{route('admin.product.store')}} @endif" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="col-sm-12">
	<div class="row">
		@csrf
		@if(isset($product))
		@method('PUT')
		...
		<ul class="list-group row">
			...
			<li class="list-group-item">
				...
				<div class="img-thumbnail  text-center">
					<img src="@if(isset($product)) {{asset($product->thumbnail)}} @else {{asset('images/no-thumbnail.jpeg')}} @endif" id="imgthumbnail" class="img-fluid" alt="">
				</div>
			</li>
			<li class="list-group-item">
				<div class="col-12">
